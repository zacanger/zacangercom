...
<html>
<head>
    <title>check yo viewportz</title>
    <meta charset="UTF-8">
...
<?php //Get URL Parameter
	$src = (empty($_GET['url'])) ? 'http://zacanger.com/blog/' : addslashes(filter_input(INPUT_GET, 'url', FILTER_SANITIZE_URL));
?>
			...
			<ul class="sg-control">
				<li class="sg-size">
					...
					<ul class="sg-acc-panel sg-size-options">
						...
						<li class="sg-half"><a href="#" class="mode-link" id="sg-size-disco">Dance</a></li>
						<li class="sg-half"><a href="#" class="mode-link" id="sg-size-hay">&gt;&gt;&gt;&gt;&gt;</a></li>
					</ul>
				</li>
			</ul>
		</div>
